...
일미리는 집 근처 1mm 앞에도 있는 의외의 반려동물 동반장소를 찾을 수 있는 서비스입니다. 다양한 가게에 리뷰를 남기거나 좋아요를 누르고, 나만의 테마리스트를 만들어서 유저들과 공유할 수 있습니다.
...
<img src="https://github.com/PaperRing/onemm_backend/assets/63621849/a5cb72d0-cf38-45e5-ab40-a53ffa50f96d"  width="300"  height="644"/> | 가게에 대한 리뷰를 작성하고 별점을 줄 수 있는 기능입니다. <br> 서버 사용 비용을 고려해 한장만 올릴 수 있도록 제한했습니다. <br> - 리뷰 `C`  `R`  `U`  `D`
--- | --- |
